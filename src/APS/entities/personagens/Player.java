...
// (Herança) - Player estende a classe base Personagens, herdando toda a sua estrutura de atributos e métodos
public class Player extends Personagens {
    ...
    // (Método Construtor) - Inicializa o estado do objeto Player e invoca o construtor da classe mãe via 'super'
    ...
    public void getBattleInventario() {
        for (String item : inventario.keySet()) {
            // (Polimorfismo de Classe) - Uso do operador 'instanceof' para verificar dinamicamente a subclasse real do objeto contido no catálogo
    ...
    private void subirNivel(Scanner sc) {
        ...
        while (true) {
            ...
            // (Tratamento de Exceções) - Bloco try-catch para capturar falhas caso o jogador digite uma entrada inválida
            try {
    ...
    // (Polimorfismo de Classe) - O método aceita um parâmetro do tipo 'Mobs', que é uma subclasse direta de Personagens
    public void atacarEspecial(Mobs inimigo) {
        ...
        switch (nome) {
            ...
            default:
                // (Polimorfismo de Classe) - Passa a instância atual (this) que é um Player para um método que espera um Personagens geral
    ...
    // (Polimorfismo de Classe) - O método aceita o parâmetro genérico 'Item', permitindo passar qualquer subclasse dele (como EquipItem ou BattleItem)
    ...
    public boolean usarItem(String nome, Mobs enemy, Player player) {
        ...
        if (item instanceof BattleItem) {
            ...
            switch (alvo) {
                ...
                case 1:
                    removerItem(nome);
                    // (Polimorfismo de Classe) - Coerção/Casting explícito para tratar o 'Item' genérico como o tipo específico 'BattleItem'
    ...
    public void statUper() {
        ...
        switch (counter) {
            ...
            case 40:
                aumento(10);
                // (Instanciação de Objeto) - Aloca um novo objeto da classe Skill e passa à lista de habilidades
